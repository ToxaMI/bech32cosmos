...
func ExampleDecode() {
	encoded := "bc:pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k7grplx"
	hrp, decoded, err := bech32cosmos.Decode(encoded)
	if err != nil {
...
func ExampleEncode() {
	...
	conv, err := bech32cosmos.ConvertBits(data, 8, 5, true)
	if err != nil {
		fmt.Println("Error:", err)
	}
	encoded, err := bech32cosmos.Encode("customHrp!11111q", conv)
	if err != nil {
		fmt.Println("Error:", err)
	}
