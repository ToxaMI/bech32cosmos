...
// Decode decodes a bech32cosmos encoded string, returning the human-readable
...
func Decode(bech string) (string, []byte, error) {
	...
	sep := strings.LastIndexByte(bech, seperator)
...
func Encode(hrp string, data []byte) (string, error) {
	...
	return hrp + string(seperator) + dataChars, nil
}
